            ...
            <div className={SIATC_THEME.LAYOUT.HEADER_WRAPPER}>
                ...
                <div className="flex items-center gap-3 self-start md:self-auto">
                    <button
                        ...
                        className="h-10 px-5 border border-border/60 bg-card text-foreground/70 rounded-lg font-bold text-[10px] shadow-sm flex items-center gap-2 transition-all hover:bg-muted/40 active:scale-95"
                    >
                        <Download className="w-3.5 h-3.5" /> {t('tarifario.exportTemplate')}
                    </button>
                    <button
                        onClick={() => setIsImportModalOpen(true)}
                        className="h-10 px-5 bg-blue-600 text-white rounded-lg font-bold text-[10px] shadow-lg flex items-center gap-2 transition-all hover:opacity-90 active:scale-95"
                    >
