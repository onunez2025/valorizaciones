...
export const SIATC_THEME = {
    ...
    LAYOUT: {
        PAGE_WRAPPER: "flex flex-col h-full bg-cb-bg min-h-0 animate-in fade-in duration-500 pt-[calc(1rem*var(--padding-scale, 1))] px-0 lg:px-[calc(1rem*var(--padding-scale, 1))] pb-[calc(0.375rem*var(--padding-scale, 1))] space-y-4 lg:rounded-cb-card border-none lg:border-[var(--layout-border-width)] border-cb-border overflow-hidden lg:shadow-[var(--layout-shadow)]",
        ...
        VIEWPORT: "flex-1 overflow-y-auto px-[calc(2rem*var(--padding-scale, 1))] pb-[calc(0.625rem*var(--padding-scale, 1))] flex flex-col custom-scrollbar relative",
    },
