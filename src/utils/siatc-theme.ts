...
export const SIATC_THEME = {
    ...
    PROFILE_LAYOUT: {
        ...
        AVATAR_RING: "w-28 h-28 rounded-full border-4 border-white dark:border-cb-bg bg-cb-bg flex items-center justify-center overflow-hidden shadow-xl ring-2 ring-primary/20",
        CAMERA_BUTTON: "absolute bottom-1 right-1 p-2 bg-primary text-primary-foreground rounded-full shadow-lg hover:bg-primary/90 hover:scale-110 transition-all duration-200 ring-2 ring-white dark:ring-cb-bg",
        ...
        INPUT_ACTIVE: "block w-full pl-10 pr-3 py-2.5 bg-white dark:bg-cb-bg border border-cb-border rounded-cb-btn focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all text-sm font-bold text-cb-text-primary",
