...
app.get('/api/auth/me', verifyToken, async (req, res) => {
    try {
        ...
        const freshToken = jwt.sign({ id: user.Id, username: user.Username, role: user.RoleName, perms, casId: user.cas_id || null, casRUC: user.cas_ruc || null }, JWT_SECRET, { expiresIn: '12h' });
